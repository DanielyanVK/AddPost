...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    var window: UIWindow?
    // reference's we need to set up properly
    ...
    private lazy var postRouter = AddPostRouter(mainContainer: mainContainer)
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        // using method we defined in RootRouter to assign root view controller
